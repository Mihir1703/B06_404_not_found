  ...
  return (
    <><div class="container px-6 py-16 mx-auto text-center bg-white">
            <div class="max-w-lg mx-auto">
                <h1 class="text-3xl font-semibold text-gray-800 dark:text-white lg:text-4xl">View Filled Fines on You.</h1>
            ...
            <div class="flex justify-center m-5 ">
                <h3 class="text-4xl text-gray-800 dark:text-white lg:text-4xl">Paid Fines</h3>
            </div>
                        ...
                        return (
                            <div key={index} class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 m-5 w-1/3 grid place-items-center"
                                ...
                                <div>
                                    ...
                                    <input disabled id={`txn-${fine._id}`} value={fine.transactionId} type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                                </div>
