        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2">
            ...
            <div class="p-6 border rounded-xl border-r-gray-200 dark:border-gray-700">
                <div class="md:flex md:items-start md:-mx-4">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-2xl font-medium text-gray-700 capitalize dark:text-white">View All Students</h1>

                        <p class="mt-3 text-gray-500 dark:text-gray-300">
                        View the list of all students who have signed up.
                        </p>
                        <div className="mt-5 flex justify-start w-full">
                            <a onClick={() => {
                                history('/admin/user')
            ...
            <div class="p-6 border rounded-xl border-r-gray-200 dark:border-gray-700">
                <div class="md:flex md:items-start md:-mx-4">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-2xl font-medium text-gray-700 capitalize dark:text-white">See All Complaints({complaints}) </h1>

                        <p class="mt-3 text-gray-500 dark:text-gray-300">
                        Review all complaints made by students.
                        </p>
                        <div className="mt-5 flex justify-start w-full">
                            <a onClick={() => {
            ...
            <div class="p-6 border rounded-xl border-r-gray-200 dark:border-gray-700">
                <div class="md:flex md:items-start md:-mx-4">
                    ...
                    <div class="mt-4 md:mx-4 md:mt-0">
                        <h1 class="text-2xl font-medium text-gray-700 capitalize dark:text-white">Create a notice for students.</h1>

                        <p class="mt-3 text-gray-500 dark:text-gray-300">
                        Create a notice for students.
                        </p>
                        <div className="mt-5 flex justify-start w-full">
                            <a onClick={() => {
